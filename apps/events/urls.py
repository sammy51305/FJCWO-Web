...
urlpatterns = [
    ...
    path('<int:event_pk>/intent/', views.performance_intent_set, name='performance_intent_set'),
    path('<int:pk>/intent/report/', views.performance_intent_report, name='performance_intent_report'),
