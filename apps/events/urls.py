...
urlpatterns = [
    ...
    path('<int:event_pk>/leave/', views.performance_leave_create, name='performance_leave_create'),
    path('performance-leave/review/', views.performance_leave_review_list, name='performance_leave_review_list'),
    path('performance-leave/<int:pk>/delete/', views.performance_leave_delete, name='performance_leave_delete'),
