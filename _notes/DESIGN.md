...
| `registration_review` | `GET/POST /accounts/register/review/` | 幹部審核，核准時建立正式 User 帳號並記錄 reviewed_by / reviewed_at；拒絕僅記錄狀態 |
...
路由：`/accounts/directory/create/`，幹部限定，入口在會員通訊錄頁面右上角「新增團員」按鈕。
