...
> 最後更新：2026-08-06（會費系統重構 P1–P3：期別主檔、自助申報＋確認、確認自動入帳＋當年度收支）
...
├── 演出請假申請（針對整場演出）
├── 我的請假紀錄（含排練請假與演出請假兩區）
├── 我的會費（各期繳費狀態；應繳未繳可自助申報現金、待確認可撤回）
...
│   └── 會費確認（幹部確認團員申報的繳費→已繳、或作廢→登記錯；近期紀錄管理員可硬刪）
